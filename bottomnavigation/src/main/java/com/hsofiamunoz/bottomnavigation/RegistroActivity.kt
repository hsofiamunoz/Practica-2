...
import com.hsofiamunoz.bottomnavigation.databinding.ActivityRegistroBinding
...
class RegistroActivity : AppCompatActivity() {
    ...
    //fun emailValidator(text: String): Boolean {val pattern = Patterns.EMAIL_ADDRESSreturn pattern.matcher(text).matches()}
